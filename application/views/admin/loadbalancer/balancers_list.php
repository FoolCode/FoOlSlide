...
if (is_array($balancers))
	...
	{
		echo '<tr><td>' . form_input('url[]', $item["url"]) . '</td><td><input style="text-align:right;" type="number" name="priority[]" min="0" max="100" value="' . form_prep($item["priority"]) . '" />%</td></tr>';
	}
$url["value"] = "";

echo '<tr><td>' . form_input('url[]') . '</td><td><input style="text-align:right;" type="number" name="priority[]" min="0" max="100" value="0"/>%</td></tr>';
echo '</table>';
