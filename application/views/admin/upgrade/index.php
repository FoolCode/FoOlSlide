...
echo buttoner();
echo '	
	<a href="https://www.transifex.net/projects/p/foolslide/resource/defaultpot/" target="_blank"><img src="https://www.transifex.net/projects/p/foolslide/resource/defaultpot/chart/image_png" style="float:right;" /></a>
...
if($new_versions){
	echo '<div class="list" style="clear:both;">';
